...
const AuditNotificationCenter = ({ isOpen, onClose }) => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await axios.get('https://backend-jits.onrender.com/api/notifications', {
  ...
  const markAsRead = async (notificationId) => {
    try {
      await axios.patch(`https://backend-jits.onrender.com/api/notifications/${notificationId}/read`, {}, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
      });
  ...
  const markAllAsRead = async () => {
    try {
      await axios.patch('https://backend-jits.onrender.com/api/notifications/mark-all-read', 
        { type: 'audit' },
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
