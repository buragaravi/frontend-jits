...
const CreateOtherProductRequestForm = () => {
  ...
  const createRequestMutation = useMutation({
    mutationFn: async (requestData) => {
      ...
      const response = await axios.post('https://backend-jits.onrender.com/api/other/requests', requestData, {
  ...
  const handleProductSearch = async (index, searchTerm) => {
    ...
    try {
      const response = await axios.get(`https://backend-jits.onrender.com/api/other/central/available?search=${searchTerm}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
