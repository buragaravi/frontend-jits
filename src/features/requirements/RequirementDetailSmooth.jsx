...
const RequirementDetailSmooth = ({ 
  ...
  const handleStatusUpdate = async (status = null, comment = null) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://backend-jits.onrender.com/api/requirements/${requirement._id}/status`,
        updateData,
        {
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://backend-jits.onrender.com/api/requirements/${requirement._id}/comments`,
        { comment: newComment },
        {
          headers: { Authorization: `Bearer ${token}` }
        }
  ...
  const handleConvertToQuotation = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await axios.post(
        `https://backend-jits.onrender.com/api/requirements/${requirement._id}/convert-to-quotation`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` }
        }
