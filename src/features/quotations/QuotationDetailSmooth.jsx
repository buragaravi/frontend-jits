...
const QuotationDetailSmooth = ({ quotation, isOpen, onClose, onRefresh }) => {
  ...
  const handleStatusUpdate = async (newStatus) => {
    ...
    try {
      const response = await axios.patch(
        `https://backend-jits.onrender.com/api/quotations/${quotation._id}/status`,
        { status: newStatus },
  ...
  const handleSubmitMessage = async () => {
    ...
    try {
      const response = await axios.post(
        `https://backend-jits.onrender.com/api/quotations/${quotation._id}/comments`,
  ...
  const handleSaveEdits = async () => {
    ...
    try {
      ...
      await axios.put(
        `https://backend-jits.onrender.com/api/quotations/${quotation._id}/complete`,
        updateData,
        { headers: { Authorization: `Bearer ${token}` } }
      );
