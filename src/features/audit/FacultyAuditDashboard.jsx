...
const FacultyAuditDashboard = () => {
  ...
  const fetchFacultyAssignments = async () => {
    ...
    try {
      ...
      console.log('API URL:', `https://backend-jits.onrender.com/api/audit/assignments/faculty/${user.id}`);
      
      const response = await axios.get(`https://backend-jits.onrender.com/api/audit/assignments/faculty/${user.id}`, {
  ...
  const fetchFacultyStats = async () => {
    ...
    try {
      const response = await axios.get(`https://backend-jits.onrender.com/api/audit/faculty-stats/${user.id}`, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
      });
  ...
  const handleStartAudit = async (assignment) => {
    try {
      ...
      const response = await axios.patch(
        `https://backend-jits.onrender.com/api/audit/assignments/${assignment._id}/start`,
        {},
        { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }
      );
